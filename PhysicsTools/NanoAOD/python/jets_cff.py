...
fatJetTable = cms.EDProducer("SimpleCandidateFlatTableProducer",
    ...
    variables = cms.PSet(P4Vars,
        ...
        particleNet_massRetrained = Var("bDiscriminator('pfParticleNetRetrainedMassRegressionJetTags:mass')",float,doc="ParticleNet mass regression, retrained",precision=10),
        particleNet_massAlternative = Var("bDiscriminator('pfParticleNetAlternativeMassRegressionJetTags:mass')",float,doc="ParticleNet mass regression, alternative retraining with reweighting in sqrt(fj_genjet_mass*fj_genjet_sdmass) with wider bins",precision=10),
